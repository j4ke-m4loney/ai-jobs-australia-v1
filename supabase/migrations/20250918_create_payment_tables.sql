...
-- Add featured job fields to jobs table (if they don't exist)
...
CREATE INDEX IF NOT EXISTS idx_jobs_payment_id ON public.jobs(payment_id);
CREATE INDEX IF NOT EXISTS idx_jobs_is_featured ON public.jobs(is_featured);
CREATE INDEX IF NOT EXISTS idx_jobs_featured_until ON public.jobs(featured_until);
CREATE INDEX IF NOT EXISTS idx_jobs_featured_order ON public.jobs(featured_order);
