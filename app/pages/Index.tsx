      ...
      <section className="pt-20 pb-16 bg-gradient-to-br from-background via-muted/30 to-primary-light/20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Search Form */}
            <div className="bg-card rounded-2xl p-6 shadow-lg border border-border/50 mb-12">
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            ...
            <Button
              variant="outline"
              onClick={() =>
                user ? navigate("/jobs") : navigate("/auth/jobseeker")
              }
              className="gap-2"
            >
              View All Jobs
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-12">
            {topCompanies.map((company) => (
              <Card
                key={company.name}
                className="hover:shadow-md transition-all cursor-pointer group p-6"
              >
                <div className="text-center">
